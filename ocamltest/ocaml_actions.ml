...
let lldb = Actions.make ~name:"lldb" ~description:"Run LLDB on the program" (debug_native LLDB)
let gdb = Actions.make ~name:"gdb" ~description:"Run GDB on the program" (debug_native GDB)
