...
(* Integer register map:
    ...
    31                  frame pointer (when enabled via --enable-frame-pointers)
...
let num_available_registers = [| 22; 32 |]  (* r23 reserved for ALLOC_PTR *)
...
let safe_register_pressure = function
    Iextcall _ -> 13
  | _ -> 22  (* r23 reserved for ALLOC_PTR *)

let max_register_pressure = function
    Iextcall _ -> [| 13; 18 |]
  | Iintoffloat | Istore(Single, _, _) -> [| 22; 31 |]
  | _ -> [| 22; 32 |]  (* r23 reserved for ALLOC_PTR *)
